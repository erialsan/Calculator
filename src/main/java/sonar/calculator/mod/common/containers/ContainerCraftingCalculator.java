...
public class ContainerCraftingCalculator extends Container {
    ...
    private static final int INV_START = CraftingCalc.CraftingInventory.size, INV_END = INV_START + 26,
    ...
    public ContainerCraftingCalculator(EntityPlayer player, InventoryPlayer inventoryPlayer,
