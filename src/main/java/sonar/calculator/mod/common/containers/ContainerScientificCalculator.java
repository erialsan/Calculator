...
public class ContainerScientificCalculator extends Container implements ICalculatorCrafter {
    ...
    private static final int INV_START = CalculatorItem.CalculatorInventory.size, INV_END = INV_START + 26,
        HOTBAR_START = INV_END + 1, HOTBAR_END = HOTBAR_START + 8;
    private EntityPlayer player;

    public ContainerScientificCalculator(EntityPlayer player, InventoryPlayer inventoryPlayer,
        ...
        this.addSlotToContainer(
            new SlotPortableCrafting(this, inventory, 0, 25, 35, isRemote, Calculator.itemScientificCalculator));
        this.addSlotToContainer(
            new SlotPortableCrafting(this, inventory, 1, 79, 35, isRemote, Calculator.itemScientificCalculator));
        this.addSlotToContainer(
            new SlotPortableResult(player, inventory, this, new int[] { 0, 1 }, 2, 134, 35, isRemote));
    ...
    public void removeEnergy() {
        if (!this.isRemote) {
            ...
            if (player.getHeldItem() != null && player.getHeldItem()
                ...
                IEnergyContainerItem energy = (IEnergyContainerItem) player.getHeldItem()
                    .getItem();
