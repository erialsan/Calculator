...
public class ContainerStorageModule extends Container {
    ...
    private static final int INV_START = StorageModule.StorageInventory.size, INV_END = INV_START + 26,
    ...
    public ContainerStorageModule(EntityPlayer player, InventoryPlayer inventoryPlayer, InventoryItem inventoryItem) {
        ...
        for (j = 0; j < 9; ++j) {
            this.addSlotToContainer(
                new SlotLimiter(inventoryPlayer, j, 8 + j * 18, 162 + i, Calculator.itemStorageModule));
        }
    }
