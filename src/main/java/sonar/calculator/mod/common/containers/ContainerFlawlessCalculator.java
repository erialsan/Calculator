...
public class ContainerFlawlessCalculator extends Container implements ICalculatorCrafter {
    ...
    private static final int INV_START = FlawlessCalc.FlawlessInventory.size, INV_END = INV_START + 26,
        HOTBAR_START = INV_END + 1, HOTBAR_END = HOTBAR_START + 8;

    public ContainerFlawlessCalculator(EntityPlayer player, InventoryPlayer inventoryPlayer,
        ...
        for (int k = 0; k < 4; k++) {
            addSlotToContainer(
                new SlotPortableCrafting(
                    ...
                    35,
                    isRemote,
                    Calculator.itemFlawlessCalculator));
        }

        addSlotToContainer(
            new SlotPortableResult(player, inventory, this, new int[] { 0, 1, 2, 3 }, 4, 145, 35, isRemote));
