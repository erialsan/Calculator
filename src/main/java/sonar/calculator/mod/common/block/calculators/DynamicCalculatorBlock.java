    ...
    public boolean operateBlock(World world, int x, int y, int z, EntityPlayer player, BlockInteraction interact) {
        if (player != null) {
            ...
            if (target != null && target instanceof TileEntityCalculator.Dynamic) {
                ...
                /*
                 * FailedCoords coords = calc.checkStructure(); if (coords.getObject()) {
                 * player.openGui(Calculator.instance, CalculatorGui.DynamicCalculator, world, x, y, z); } else { if
                 * (!world.isRemote) { FontHelper.sendMessage("No Multi-block", world, player);
                 * FontHelper.sendMessage("X: " + coords.getX() + " Y: " + coords.getY() + " Z: " + coords.getZ() +
                 * " - " +
