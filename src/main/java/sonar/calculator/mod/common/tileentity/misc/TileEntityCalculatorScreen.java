...
public class TileEntityCalculatorScreen extends TileEntitySonar {
    ...
    public void updateEntity() {
        ...
        if (this.worldObj != null && !this.worldObj.isRemote) {
            TileEntity target = SonarHelper.getAdjacentTileEntity(
                this,
    ...
    public void sendMax(int max) {
        ...
        this.latestMax = max;
        if (!this.worldObj.isRemote) Calculator.network.sendToAllAround(
            new PacketCalculatorScreen(xCoord, yCoord, zCoord, 0, max),
            new TargetPoint(this.worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 64));
    ...
    public void sendEnergy(int energy) {
        ...
        if (!this.worldObj.isRemote) Calculator.network.sendToAllAround(
            new PacketCalculatorScreen(xCoord, yCoord, zCoord, 1, energy),
            new TargetPoint(this.worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 64));
    }
