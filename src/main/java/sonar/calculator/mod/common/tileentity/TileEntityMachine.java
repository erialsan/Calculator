    ...
    public static class ReinforcedFurnace extends TileEntityAbstractProcess {
        ...
        public ReinforcedFurnace() {
            super(
                1,
                1,
                CalculatorConfig.getInteger("Reinforced Furnace" + "Base Speed"),
                CalculatorConfig.getInteger("Reinforced Furnace" + "Energy Usage"));
        }

        @Override
        public ItemStack[] getOutput(boolean simulate, ItemStack... stacks) {
            return new ItemStack[] { FurnaceRecipes.smelting()
                .getSmeltingResult(stacks[0]) };
        }
    }
    ...
    public static class StoneSeperator extends TileEntityAbstractProcess {
        ...
        public StoneSeperator() {
            super(
                1,
                2,
                CalculatorConfig.getInteger("Stone Seperator" + "Base Speed"),
                CalculatorConfig.getInteger("Stone Seperator" + "Energy Usage"));
        }
    ...
    public static class ReassemblyChamber extends TileEntityAbstractProcess {
        ...
        public ReassemblyChamber() {
            super(
                1,
                1,
                CalculatorConfig.getInteger("Reassembly Chamber" + "Base Speed"),
                CalculatorConfig.getInteger("Reassembly Chamber" + "Energy Usage"));
        }
    ...
    public static class RestorationChamber extends TileEntityAbstractProcess {
        ...
        public RestorationChamber() {
            super(
                1,
                1,
                CalculatorConfig.getInteger("Restoration Chamber" + "Base Speed"),
                CalculatorConfig.getInteger("Restoration Chamber" + "Energy Usage"));
        }
    ...
    public static class ProcessingChamber extends TileEntityAbstractProcess {
        ...
        public ProcessingChamber() {
            super(
                1,
                1,
                CalculatorConfig.getInteger("Processing Chamber" + "Base Speed"),
                CalculatorConfig.getInteger("Processing Chamber" + "Energy Usage"));
        }
    ...
    public static class AlgorithmSeperator extends TileEntityAbstractProcess {
        ...
        public AlgorithmSeperator() {
            super(
                1,
                2,
                CalculatorConfig.getInteger("Algorithm Seperator" + "Base Speed"),
                CalculatorConfig.getInteger("Algorithm Seperator" + "Energy Usage"));
        }
    ...
    public static class ExtractionChamber extends TileEntityAbstractProcess {
        ...
        public ExtractionChamber() {
            super(
                1,
                2,
                CalculatorConfig.getInteger("Extraction Chamber" + "Base Speed"),
                CalculatorConfig.getInteger("Extraction Chamber" + "Energy Usage"));
        }
        ...
        public ItemStack[] getOutput(boolean simulate, ItemStack... stacks) {
            if (simulate) {
                ...
                outputs[1] = rand.nextInt(8 + 1) == 8 ? new ItemStack(outputs[1].getItem(), 1, rand.nextInt(13 + 1))
                    : null;
                return outputs;
            }
        }
    ...
    public static class PrecisionChamber extends TileEntityAbstractProcess {
        ...
        public PrecisionChamber() {
            super(
                1,
                2,
                CalculatorConfig.getInteger("Precision Chamber" + "Base Speed"),
                CalculatorConfig.getInteger("Precision Chamber" + "Energy Usage"));
        }
        ...
        public ItemStack[] getOutput(boolean simulate, ItemStack... stacks) {
            if (simulate) {
                ...
                ItemStack[] outputs = recipeHelper().getOutput(stacks);
                if (recipeHelper().containsStack(new ItemStack(Blocks.cobblestone, 1), stacks, false) != -1
                    || recipeHelper().containsStack(new ItemStack(Blocks.dirt, 1), stacks, false) != -1) {
