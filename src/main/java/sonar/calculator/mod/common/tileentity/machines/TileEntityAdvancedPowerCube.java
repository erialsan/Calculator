...
@Optional.InterfaceList(
    value = { @Optional.Interface(iface = "ic2.api.energy.tile.IEnergySource", modid = "IC2", striprefs = true),
...
public class TileEntityAdvancedPowerCube extends TileEntityPowerCube implements IEnergySource {
    ...
    public void addEnergy() {
        ...
        if (SonarHelper.isEnergyHandlerFromSide(entity, dir.getOpposite())) {
            ...
            if (entity != null) this.storage.modifyEnergyStored(
                -SonarHelper
                    .pushEnergy(entity, dir.getOpposite(), this.storage.extractEnergy(maxTransfer, true), false));
        }
    }
