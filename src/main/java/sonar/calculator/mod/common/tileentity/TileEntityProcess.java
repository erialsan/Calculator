...
public abstract class TileEntityProcess extends TileEntitySidedInventoryReceiver
    implements IUpgradeCircuits, IPausable, IAdditionalInventory, IProcessMachine, IByteBufTile {
    ...
    public int getProcessTime() {
        ...
        /*
         * int i = 16 - sUpgrade.getObject(); if (sUpgrade.getObject() == 0) { return 1000; } return ((8 + ((i * i) * 2
         * + i)));
         */
        ...
        if (id == 0) {
            for (int i = 0; i < 3; i++) {
                if (getUpgrades(i) != 0 && UpgradeCircuit.getItem(i) != null) {
                    ...
                    EntityItem upgrade = new EntityItem(
                        worldObj,
                        xCoord + dir.offsetX,
                        yCoord + 0.5,
                        zCoord + dir.offsetZ,
                        new ItemStack(UpgradeCircuit.getItem(i), getUpgrades(i)));
