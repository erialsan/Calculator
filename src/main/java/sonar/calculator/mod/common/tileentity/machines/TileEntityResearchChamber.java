...
public class TileEntityResearchChamber extends TileEntityInventory implements ISyncTile {
    ...
    public void beginResearch() {
        ...
        if ((CalculatorRecipes.instance()
            .validInput(slots[0])
            || CalculatorRecipes.instance()
                .validOutput(slots[0]))
            || slots[0].getItem() == Calculator.circuitBoard && slots[0].getItem() instanceof IStability
    ...
    public void readData(NBTTagCompound nbt, SyncType type) {
        ...
        if (type != SyncType.SYNC) {
            this.unblocked = CalculatorRecipes.instance()
                .readFromNBT(nbt, "unblocked");
        }
    ...
    public void writeData(NBTTagCompound nbt, SyncType type) {
        ...
        if (type != SyncType.SYNC) {
            CalculatorRecipes.instance()
                .writeToNBT(nbt, unblocked, "unblocked");
        }
