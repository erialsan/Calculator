...
public class TileEntityAtomicMultiplier extends TileEntityInventoryReceiver
    implements ISidedInventory, IProcessMachine {
    ...
    public static boolean isAllowed(ItemStack stack) {
        return AtomicMultiplierBlacklist.blacklist()
            .isAllowed(stack.getItem());
    }
    ...
    public int[] getAccessibleSlotsFromSide(int slot) {
        return slot == 0 ? output
            : slot == 1 ? input
                : slot == 2 ? circuits : slot == 3 ? circuits : slot == 4 ? circuits : slot == 5 ? circuits : input;
    }
