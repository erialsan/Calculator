...
public class RecipeRegistry {
    ...
    private static void addStandardRecipes() {
        ...
        registerCalculatorRecipe(
            new ItemStack(Calculator.reinforcedstoneBrick, 2),
            Calculator.reinforcedstoneBlock,
            Calculator.reinforcedstoneBlock,
            false);
        registerCalculatorRecipe(new ItemStack(Calculator.stableglassBlock, 2), "blockGlass", "blockGlass", false);
        registerCalculatorRecipe(
            new ItemStack(Calculator.stablestoneBlock, 2),
            Calculator.reinforcedstoneBrick,
            Calculator.reinforcedstoneBrick,
            false);
        registerCalculatorRecipe(
            new ItemStack(Calculator.reinforceddirtBrick, 2),
            Calculator.reinforceddirtBlock,
            Calculator.reinforceddirtBlock,
            false);
        ...
        /*
         * // calculator recipes
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforcedstoneBlock, 8), "cobblestone", Items.clay_ball,
         * true);
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforceddirtBlock, 2, 2), "stone", new
         * ItemStack(Blocks.dirt, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforceddirtBlock, 1, 2), "cobblestone", new
         * ItemStack(Blocks.dirt, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforceddirtBlock, 4), new ItemStack(Blocks.grass, 1),
         * Blocks.log, true);
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforceddirtBlock, 4), new ItemStack(Blocks.grass, 1),
         * Blocks.log2, true);
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforceddirtBlock, 1), new ItemStack(Blocks.grass, 1),
         * new ItemStack(Blocks.planks, 1), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Calculator.reinforcedstoneBlock, 1), "cobblestone", "plankWood",
         * true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.dirt, 1, 2), new ItemStack(Blocks.grass, 1), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.dirt, 1, 2), new ItemStack(Blocks.grass, 1), new
         * ItemStack(Blocks.red_mushroom_block, 1, 5), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.dirt, 1, 2), new ItemStack(Blocks.grass, 1), new
         * ItemStack(Blocks.brown_mushroom_block, 1, 5), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 0), Blocks.vine, new ItemStack(Blocks.leaves, 1, 0),
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 1), Blocks.vine, new ItemStack(Blocks.leaves, 1, 1),
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 2), Blocks.vine, new ItemStack(Blocks.leaves, 1, 2),
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 4, 3), Blocks.vine, new ItemStack(Blocks.leaves, 1, 3),
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 4, 0), Blocks.vine, new ItemStack(Blocks.leaves2, 1,
         * 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 4, 1), Blocks.vine, new ItemStack(Blocks.leaves2, 1,
         * 1), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_glass_pane, 1, 7), "cobblestone", Blocks.glass_pane,
         * true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.mycelium, 2), new ItemStack(Blocks.grass, 1), new
         * ItemStack(Blocks.dirt, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.mycelium, 2), new ItemStack(Blocks.grass, 1), new
         * ItemStack(Blocks.grass, 1), true);
         * // standard items
         ...
         * registerCalculatorRecipe(new ItemStack(Items.rotten_flesh, 16), new ItemStack(Items.skull, 1, 2),
         * "ingotIron", true);
         * registerCalculatorRecipe(new ItemStack(Items.gunpowder, 16), new ItemStack(Items.skull, 1, 4), "ingotIron",
         * true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), Items.blaze_powder,
         * true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), new
         * ItemStack(Items.dye, 1, 14), true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), new
         * ItemStack(Blocks.stained_hardened_clay, 1, 1), true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), new
         * ItemStack(Blocks.wool, 1, 1), true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), new
         * ItemStack(Blocks.stained_glass, 1, 1), true);
         * registerCalculatorRecipe(Items.lava_bucket, Items.water_bucket.setContainerItem(null), new
         * ItemStack(Blocks.red_flower, 1, 5), true);
         * // specials
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.crafting_table, 2), Blocks.furnace, new
         * ItemStack(Blocks.planks, 1), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.end_portal_frame, 3), Blocks.enchanting_table, Items.ender_eye,
         * true);
         ...
         * for (int i = 0; i < 6; i++) {
         * if (i != 3 && i != 4 && i != 5) {
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, i), new ItemStack(Blocks.log, 1, i + 1), new
         * ItemStack(Blocks.log, 1, i + 1), true);
         * }
         * if (i == 3) {
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, i), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.log2, 1, 0), true);
         * } else if (i == 4) {
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.log2, 1, 1), true);
         * } else if (i == 5) {
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log, 1, 0), new
         * ItemStack(Blocks.log, 1, 0), true);
         * }
         * }
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 1), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.log, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.log, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 0), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.log, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log, 1, 0), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 2), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.log2, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log, 1, 0), new
         * ItemStack(Blocks.log, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.log, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 2, 3), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.log, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.log2, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 0), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.log, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log, 1, 1), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 2, 1), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.log, 1, 0), true);
         * // plank recipes
         * for (int i = 0; i < 6; i++) {
         * if (i != 6) {
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, i), new ItemStack(Blocks.planks, 1, i + 1), new
         * ItemStack(Blocks.planks, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, i), new ItemStack(Blocks.planks, 1, 0), new
         * ItemStack(Blocks.planks, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 6; i++) {
         * if (i != 6) {
         * registerCalculatorRecipe(new ItemStack(Blocks.wooden_slab, 2, i), new ItemStack(Blocks.wooden_slab, 1, i +
         * 1), new ItemStack(Blocks.wooden_slab, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.wooden_slab, 2, i), new ItemStack(Blocks.wooden_slab, 1, 0),
         * new ItemStack(Blocks.wooden_slab, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 7; i++) {
         * if (i != 7) {
         * registerCalculatorRecipe(new ItemStack(Blocks.stone_slab, 2, i), new ItemStack(Blocks.stone_slab, 1, i + 1),
         * new ItemStack(Blocks.stone_slab, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.stone_slab, 2, i), new ItemStack(Blocks.stone_slab, 1, 0), new
         * ItemStack(Blocks.stone_slab, 1, 0), true);
         * }
         * }
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 0), new ItemStack(Blocks.planks, 1, 2), new
         * ItemStack(Blocks.planks, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 0), new ItemStack(Blocks.planks, 1, 5), new
         * ItemStack(Blocks.planks, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 2), new
         * ItemStack(Blocks.planks, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 5), new
         * ItemStack(Blocks.planks, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 4), new
         * ItemStack(Blocks.planks, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 1), new ItemStack(Blocks.planks, 1, 5), new
         * ItemStack(Blocks.planks, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 0), new
         * ItemStack(Blocks.planks, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 4), new
         * ItemStack(Blocks.planks, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 2), new ItemStack(Blocks.planks, 1, 4), new
         * ItemStack(Blocks.planks, 1, 5), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 0), new
         * ItemStack(Blocks.planks, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 3), new ItemStack(Blocks.planks, 1, 4), new
         * ItemStack(Blocks.planks, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 4), new ItemStack(Blocks.planks, 1, 2), new
         * ItemStack(Blocks.planks, 1, 4), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 4), new ItemStack(Blocks.planks, 1, 2), new
         * ItemStack(Blocks.planks, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1, 1), new
         * ItemStack(Blocks.planks, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1, 5), new
         * ItemStack(Blocks.planks, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.planks, 2, 5), new ItemStack(Blocks.planks, 1), true);
         * // sapling recipes
         * for (int i = 0; i < 6; i++) {
         * if (i != 6) {
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, i), new ItemStack(Blocks.sapling, 1, i + 1), new
         * ItemStack(Blocks.sapling, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, i), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.sapling, 1, 0), true);
         * }
         * }
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 0), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.sapling, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 0), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.sapling, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.sapling, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.sapling, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.sapling, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.sapling, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.sapling, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.sapling, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 2), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.sapling, 1, 5), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.sapling, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 3), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.sapling, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 4), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.sapling, 1, 4), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 4), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.sapling, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 5), new ItemStack(Blocks.sapling, 1, 1), new
         * ItemStack(Blocks.sapling, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 2, 5), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.sapling, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 0), new ItemStack(Blocks.log, 1, 0), new
         * ItemStack(Blocks.leaves, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 1), new ItemStack(Blocks.log, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 2), new ItemStack(Blocks.log, 1, 2), new
         * ItemStack(Blocks.leaves, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 3), new ItemStack(Blocks.log, 1, 3), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 4), new ItemStack(Blocks.log2, 1, 0), new
         * ItemStack(Blocks.leaves, 1, 4), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.sapling, 1, 5), new ItemStack(Blocks.log2, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 5), true);
         * // leave recipes
         * for (int i = 0; i < 6; i++) {
         * if (i != 3 && i != 4 && i != 5) {
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, i), new ItemStack(Blocks.leaves, 1, i + 1), new
         * ItemStack(Blocks.leaves, 1, i + 1), true);
         * }
         * if (i == 3) {
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, i), new ItemStack(Blocks.leaves2, 1), new
         * ItemStack(Blocks.leaves2, 1), true);
         * } else if (i == 4) {
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves2, 1, 1), new
         * ItemStack(Blocks.leaves2, 1, 1), true);
         * } else if (i == 5) {
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves, 1), new
         * ItemStack(Blocks.leaves, 1), true);
         * }
         * }
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 0), new ItemStack(Blocks.leaves, 1, 2), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 0), new ItemStack(Blocks.leaves2, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves, 1, 2), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves, 1), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves2, 1), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 2), new ItemStack(Blocks.leaves2, 1), new
         * ItemStack(Blocks.leaves2, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves, 1), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves2), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves, 2, 3), new ItemStack(Blocks.leaves2), new
         * ItemStack(Blocks.leaves, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), new
         * ItemStack(Blocks.leaves2, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), new
         * ItemStack(Blocks.leaves, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2), new ItemStack(Blocks.leaves, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves2, 1, 1), new
         * ItemStack(Blocks.leaves, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.leaves2, 2, 1), new ItemStack(Blocks.leaves, 1), true);
         * // special log recipes
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.sapling, 1, 0), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 1), new ItemStack(Blocks.sapling, 1, 1), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.sapling, 1, 2), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 3), new ItemStack(Blocks.sapling, 1, 3), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.sapling, 1, 4), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.sapling, 1, 5), Blocks.dirt,
         * true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 0), new ItemStack(Blocks.sapling, 1), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 1), new ItemStack(Blocks.sapling, 1, 1), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 2), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 1, 3), new ItemStack(Blocks.sapling, 1, 3), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 1, 0), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.grass, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 1, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.planks, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 0), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.leaves, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 1), new ItemStack(Blocks.sapling, 1, 1), new
         * ItemStack(Blocks.leaves, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 2), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.leaves, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 3), new ItemStack(Blocks.sapling, 1, 3), new
         * ItemStack(Blocks.leaves, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 4, 0), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.leaves2, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 4, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.leaves2, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 0), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.planks, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 4, 1), new ItemStack(Blocks.sapling, 1, 1), new
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 4, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.planks, 1, 5), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 8, 0), new ItemStack(Blocks.sapling, 1, 0), new
         * ItemStack(Blocks.log, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 8, 1), new ItemStack(Blocks.sapling, 1, 1), new
         * ItemStack(Blocks.log, 1, 1), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 8, 2), new ItemStack(Blocks.sapling, 1, 2), new
         * ItemStack(Blocks.log, 1, 2), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log, 8, 3), new ItemStack(Blocks.sapling, 1, 3), new
         * ItemStack(Blocks.log, 1, 3), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 8, 0), new ItemStack(Blocks.sapling, 1, 4), new
         * ItemStack(Blocks.log2, 1, 0), true);
         * registerCalculatorRecipe(new ItemStack(Blocks.log2, 8, 1), new ItemStack(Blocks.sapling, 1, 5), new
         * ItemStack(Blocks.log2, 1, 1), true);
         * // new
         ...
         * registerCalculatorRecipe(new ItemStack(Calculator.enrichedgold_ingot, 2), Calculator.reinforcediron_ingot,
         * new ItemStack(Items.dye, 1, 11), true);
         * registerCalculatorRecipe(new ItemStack(Calculator.weakeneddiamond, 6), "gemEmerald", new ItemStack(Items.dye,
         * 1, 4), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Calculator.calculator_assembly, 8), "ingotIron", Blocks.stone_button,
         * true);
         * registerCalculatorRecipe(new ItemStack(Calculator.calculator_screen, 8), Calculator.redstone_ingot,
         * "cobblestone", true);
         ...
         * registerCalculatorRecipe(Blocks.vine, new ItemStack(Blocks.tallgrass, 1, 1), new ItemStack(Blocks.tallgrass,
         * 1, 1), true);
         ...
         * registerCalculatorRecipe(new ItemStack(Blocks.piston, 1), new ItemStack(Calculator.reinforcediron_ingot, 1),
         * "logWood", true);
         * registerCalculatorRecipe(new ItemStack(Blocks.noteblock, 8), new ItemStack(Calculator.redstone_ingot, 1),
         * "logWood", true);
         * registerCalculatorRecipe(new ItemStack(Blocks.noteblock, 2), new ItemStack(Calculator.redstone_ingot, 1),
         * "plankWood", true);
         ...
         * registerCalculatorRecipe(new ItemStack(Items.slime_ball, 2), Calculator.rotten_pear, Calculator.rotten_pear,
         * true);
         ...
         * registerCalculatorRecipe(new ItemStack(Items.wheat, 8), new ItemStack(Blocks.tallgrass, 1, 1), "treeSapling",
         * true);
         * registerCalculatorRecipe(new ItemStack(Items.wheat_seeds, 1), new ItemStack(Blocks.vine), "treeSapling",
         * true);
         ...
         * for (int i = 0; i < 9; i++) {
         * registerCalculatorRecipe(new ItemStack(Blocks.vine, 16), new ItemStack(Blocks.red_flower, 1, i),
         * "treeSapling", true);
         * }
         * for (int i = 0; i < 9; i++) {
         * if (i != 8) {
         * registerCalculatorRecipe(new ItemStack(Blocks.red_flower, 2, i), new ItemStack(Blocks.red_flower, 1, i + 1),
         * new ItemStack(Blocks.red_flower, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.red_flower, 2, i), new ItemStack(Blocks.red_flower, 1, 0), new
         * ItemStack(Blocks.red_flower, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Blocks.wool, 2, i), new ItemStack(Blocks.wool, 1, i + 1), new
         * ItemStack(Blocks.wool, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.wool, 2, i), new ItemStack(Blocks.wool, 1, 0), new
         * ItemStack(Blocks.wool, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_glass, 2, i), new ItemStack(Blocks.stained_glass, 1, i
         * + 1), new ItemStack(Blocks.stained_glass, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_glass, 2, i), new ItemStack(Blocks.stained_glass, 1,
         * 0), new ItemStack(Blocks.stained_glass, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_glass_pane, 2, i), new
         * ItemStack(Blocks.stained_glass_pane, 1, i + 1), new ItemStack(Blocks.stained_glass_pane, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_glass_pane, 2, i), new
         * ItemStack(Blocks.stained_glass_pane, 1, 0), new ItemStack(Blocks.stained_glass_pane, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_hardened_clay, 2, i), new
         * ItemStack(Blocks.stained_hardened_clay, 1, i + 1),
         * new ItemStack(Blocks.stained_hardened_clay, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.stained_hardened_clay, 2, i), new
         * ItemStack(Blocks.stained_hardened_clay, 1, 0), new ItemStack(Blocks.stained_hardened_clay, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Blocks.carpet, 2, i), new ItemStack(Blocks.carpet, 1, i + 1), new
         * ItemStack(Blocks.carpet, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.carpet, 2, i), new ItemStack(Blocks.carpet, 1, 0), new
         * ItemStack(Blocks.carpet, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 16; i++) {
         * if (i != 15) {
         * registerCalculatorRecipe(new ItemStack(Items.dye, 2, i), new ItemStack(Items.dye, 1, i + 1), new
         * ItemStack(Items.dye, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Items.dye, 2, i), new ItemStack(Items.dye, 1, 0), new
         * ItemStack(Items.dye, 1, 0), true);
         * }
         * }
         * for (int i = 0; i < 6; i++) {
         * if (i != 5) {
         * if (i == 1) {
         * registerCalculatorRecipe(new ItemStack(Blocks.double_plant, 2, i), new ItemStack(Blocks.tallgrass, 1, 1), new
         * ItemStack(Blocks.tallgrass, 1, 1), true);
         * } else if (i == 2) {
         * registerCalculatorRecipe(new ItemStack(Blocks.tallgrass, 2, 1), new ItemStack(Blocks.tallgrass, 1, 2), new
         * ItemStack(Blocks.tallgrass, 1, 2), true);
         * } else if (i == 3) {
         * registerCalculatorRecipe(new ItemStack(Blocks.tallgrass, 2, 2), new ItemStack(Blocks.double_plant, 1, i + 1),
         * new ItemStack(Blocks.double_plant, 1, i + 1), true);
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.double_plant, 2, i), new ItemStack(Blocks.double_plant, 1, i +
         * 1), new ItemStack(Blocks.double_plant, 1, i + 1), true);
         * }
         * } else {
         * registerCalculatorRecipe(new ItemStack(Blocks.double_plant, 2, i), new ItemStack(Blocks.double_plant, 1, 0),
         * new ItemStack(Blocks.double_plant, 1, 0), true);
         * }
         * }
         */
    ...
    private static void addScientificRecipes() {
        ...
        registerScientificRecipe(
            "gemDiamond",
            Calculator.reinforcediron_ingot,
            new ItemStack(Calculator.weakeneddiamond, 4));
    ...
    private static void addAtomicRecipes() {
        ...
        registerAtomicRecipe(
            Calculator.AmethystSapling,
            Blocks.end_stone,
            Calculator.tanzaniteSapling,
            Calculator.PearSapling);
        registerAtomicRecipe(
            Calculator.itemScientificCalculator,
            Calculator.atomic_binder,
            Calculator.redstone_ingot,
            Calculator.itemAdvancedTerrainModule);
        registerAtomicRecipe(
            Calculator.tanzaniteLog,
            Calculator.atomic_binder,
            Calculator.tanzaniteLeaf,
            Calculator.tanzaniteSapling);
        registerAtomicRecipe(
            Calculator.large_tanzanite,
            Calculator.atomic_binder,
            "treeSapling",
            Calculator.tanzaniteSapling);
        registerAtomicRecipe(
            Calculator.healthprocessor,
            Calculator.itemEnergyModule,
            Calculator.hungerprocessor,
            Calculator.itemNutritionModule);
        registerAtomicRecipe(
            new ItemStack(Calculator.circuitBoard, 1, 4),
            Calculator.atomic_binder,
            "dustEnrichedGold",
            new ItemStack(Calculator.speedUpgrade, 4));
        registerAtomicRecipe(
            new ItemStack(Calculator.circuitBoard, 1, 5),
            Calculator.atomic_binder,
            "dustEnrichedGold",
            new ItemStack(Calculator.energyUpgrade, 4));
        registerAtomicRecipe(
            new ItemStack(Calculator.circuitBoard, 1, 6),
            Calculator.atomic_binder,
            "dustEnrichedGold",
            Calculator.voidUpgrade);
        registerAtomicRecipe(
            new ItemStack(Calculator.circuitBoard, 1, 9),
            Calculator.redstoneextractor,
            Calculator.large_tanzanite,
            Calculator.glowstoneextractor);
        registerAtomicRecipe(
            Calculator.redstone_ingot,
            Calculator.starchextractor,
            Calculator.redstone_ingot,
            Calculator.redstoneextractor);
        registerAtomicRecipe(
            Calculator.itemEnergyModule,
        ...
        registerAtomicRecipe(
            Calculator.reinforced_iron_block,
            Blocks.chest,
            Calculator.reinforced_iron_block,
            Calculator.storageChamber);
        registerAtomicRecipe(
            Calculator.reassemblyChamber,
            Calculator.flawlessdiamond,
            Calculator.restorationChamber,
            Calculator.processingChamber);
        registerAtomicRecipe(
            Calculator.reinforcediron_ingot,
            Blocks.chest,
            Calculator.reinforcediron_ingot,
            Calculator.itemStorageModule);
        registerAtomicRecipe(
            Calculator.reinforcediron_ingot,
        ...
        registerAtomicRecipe(
            ...
            Calculator.flawlessfirediamond,
            Calculator.reinforcediron_ingot,
            new ItemStack(Calculator.weatherStation, 4));
    }

    private static void addFlawlessRecipes() {
        registerFlawlessRecipe(
            Calculator.PearSapling,
            Calculator.enddiamond,
            Calculator.enddiamond,
            Blocks.end_stone,
            Calculator.diamondSapling);
        ...
        registerFlawlessRecipe(
            ...
            Blocks.obsidian,
            Blocks.obsidian,
            Calculator.purifiedobsidianBlock);
        registerFlawlessRecipe(
            Calculator.broccoli,
            Calculator.broccoli,
            Calculator.broccoli,
        ...
        registerFlawlessRecipe(
            ...
            Calculator.itemCalculator,
            Calculator.itemEnergyModule,
            Calculator.itemLocatorModule);
        registerFlawlessRecipe(
            Calculator.flawlessdiamond,
            "blockGlass",
            "blockGlass",
            Calculator.flawlessdiamond,
            new ItemStack(Calculator.flawlessGlass, 4));
        registerFlawlessRecipe(
            Calculator.circuitBoard,
            Calculator.enriched_coal,
            Calculator.enriched_coal,
            Calculator.circuitBoard,
            new ItemStack(Calculator.controlled_Fuel, 4));
        registerFlawlessRecipe(
            Calculator.gas_lantern_off,
            new ItemStack(Calculator.circuitBoard, 1, 8),
            new ItemStack(Calculator.circuitBoard, 1, 8),
            Calculator.gas_lantern_off,
    ...
    public static class CalculatorRecipes extends RecipeHelper {
        ...
        public void addRecipes() {
            ...
            /*
             * for (int i = 0; i < RecipeRegistry.blocked.size(); i++) { currentRecipe = i;
        ...
        public List<Integer> getInputIDs(ItemStack input) {
            ...
            Iterator iterator = this.recipeList.entrySet()
                .iterator();
            int pos = 0;
