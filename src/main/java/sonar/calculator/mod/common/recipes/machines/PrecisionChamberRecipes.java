...
public class PrecisionChamberRecipes extends RecipeHelper {
    ...
    public void addRecipes() {
        addRecipe(
            "cobblestone",
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 0));
        addRecipe(Blocks.dirt, new ItemStack(Calculator.soil, 2), new ItemStack(Calculator.circuitDirty, 1, 0));
        ...
        addRecipe(
            Blocks.stonebrick,
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 2));
        addRecipe(
            "reinforcedStone",
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 3));
        ...
        addRecipe(
            Blocks.gravel,
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 6));
        ...
        addRecipe(
            Blocks.nether_brick,
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 9));
        addRecipe(
            Calculator.reinforceddirtBlock,
            new ItemStack(Calculator.soil, 2),
            new ItemStack(Calculator.circuitDirty, 1, 10));
        addRecipe(
            "sandstone",
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 11));
        addRecipe(
            Blocks.clay,
            new ItemStack(Calculator.small_stone, 2),
            new ItemStack(Calculator.circuitDamaged, 1, 12));
