...
public class AnalysingChamberRecipes {
    ...
    public ItemStack getResult(int level, int number) {
        ...
        switch (level) {
            case 1:
                iterator = this.chance1.entrySet()
                    .iterator();
                break;
            case 2:
                iterator = this.chance2.entrySet()
                    .iterator();
                break;
            case 3:
                iterator = this.chance3.entrySet()
                    .iterator();
                break;
            case 4:
                iterator = this.chance4.entrySet()
                    .iterator();
                break;
            case 5:
                iterator = this.chance5.entrySet()
                    .iterator();
                break;
    ...
    public int getChance(ItemStack stack) {
        Iterator iterator = this.level.entrySet()
            .iterator();
