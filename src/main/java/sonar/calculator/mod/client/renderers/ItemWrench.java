...
public class ItemWrench implements net.minecraftforge.client.IItemRenderer {
    ...
    public ModelWrench wrench;

    public ItemWrench(String texture) {
        this.texture = texture;
        this.wrench = new ModelWrench();
    }
