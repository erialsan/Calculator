...
public class RenderCalculatorPlug extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation onTexture = new ResourceLocation(
        "Calculator:textures/model/calculatorplugon.png");
    private static final ResourceLocation offTexture = new ResourceLocation(
        "Calculator:textures/model/calculatorplugoff.png");
