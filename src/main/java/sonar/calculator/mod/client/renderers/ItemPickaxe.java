...
import sonar.calculator.mod.client.models.ModelPickaxe;

public class ItemPickaxe implements net.minecraftforge.client.IItemRenderer {

    public String texture;
    public ModelPickaxe pick;

    public ItemPickaxe(String texture) {
        this.texture = texture;
        this.pick = new ModelPickaxe();
    }
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
        ...
        pick.render(null, 0F, 0F, 0F, 0F, 0F, 0.0625F);
    }
}
