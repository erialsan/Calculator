...
public class RenderStorageChamber extends TileEntitySpecialRenderer {
    ...
    public ResourceLocation inputT = new ResourceLocation(
        "Calculator:textures/blocks/overlays/machine_input_storage_top.png");
    public ResourceLocation outputT = new ResourceLocation(
        "Calculator:textures/blocks/overlays/machine_output_storage_top.png");
