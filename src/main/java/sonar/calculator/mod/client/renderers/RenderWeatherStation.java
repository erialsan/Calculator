...
public class RenderWeatherStation extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation baseTex = new ResourceLocation(
        "Calculator:textures/model/weatherstation_base.png");
    private static final ResourceLocation dishTex = new ResourceLocation(
        "Calculator:textures/model/weatherstation_dish.png");
