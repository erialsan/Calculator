...
public class RenderHandlers {
    ...
    public static class Teleporter extends SonarTERender {
        ...
        private static final ResourceLocation layer1 = new ResourceLocation(
            "Calculator:textures/blocks/teleporter_layer1.png");
        private static final ResourceLocation layer2 = new ResourceLocation(
            "Calculator:textures/blocks/teleporter_layer2.png");
        private static final ResourceLocation layer3 = new ResourceLocation(
            "Calculator:textures/blocks/teleporter_layer3.png");
        ...
        public void renderExtras(TileEntity entity, double x, double y, double z, float f) {
            if (entity.getWorldObj() != null && entity instanceof TileEntityTeleporter) {
                ...
                if (tile.destinationName.equals("DESTINATION") || tile.destinationName == null) return;
                ...
                for (int i = 0; i < 2; i++) {
                    for (double width = 0.4D; width < 1; width += 0.2D) {
                        ...
                        float f2 = (float) entity.getWorldObj()
                            .getTotalWorldTime() + 20;
    ...
    public static class FluxController extends SonarTERender {
        ...
        private static final ResourceLocation beam = new ResourceLocation(
            "Calculator:textures/blocks/controller_beam.png");
        ...
        public void renderExtras(TileEntity entity, double x, double y, double z, float f) {
            ...
            if (CalculatorConfig.beamEffect && entity.getWorldObj() != null
                && entity instanceof TileEntityFluxController) {
