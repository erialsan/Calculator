...
public class ItemAxe implements net.minecraftforge.client.IItemRenderer {

    public String texture;
    public ModelAxe axe;

    public ItemAxe(String texture) {
        this.texture = texture;
        this.axe = new ModelAxe();
    }
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
        ...
        axe.render(null, 0F, 0F, 0F, 0F, 0F, 0.0625F);
    }
}
