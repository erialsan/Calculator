...
public class GuiWeatherController extends GuiContainer {
    ...
    public static final ResourceLocation bground = new ResourceLocation(
        "Calculator:textures/gui/guiWeatherController.png");
    ...
    public void initGui() {
        ...
        this.buttonList.add(
            new GuiButton(
                1,
                guiLeft + (xSize / 2 - (60 / 2)) - 25,
                guiTop + 18,
                60,
                20,
                getTypeIdentifier(entity.type)));
        this.buttonList.add(
            new GuiButton(
                2,
                guiLeft + (xSize / 2 - (40 / 2)) + 35,
                guiTop + 18,
                40,
                20,
                entity.type == 0
                    ? (entity.data == 0 ? FontHelper.translate("weather.day") : FontHelper.translate("weather.night"))
                    : (entity.data == 0 ? FontHelper.translate("state.off") : FontHelper.translate("state.on"))));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            case 1:
                ...
                SonarCore.network.sendToServer(
                    new PacketByteBufServer(entity, entity.xCoord, entity.yCoord, entity.zCoord, 1 + type));
                break;
            case 2:
                if (entity.data == 1) {
                    entity.data = 0;
