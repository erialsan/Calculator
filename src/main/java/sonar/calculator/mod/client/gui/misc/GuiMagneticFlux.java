...
public class GuiMagneticFlux extends GuiSonar {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
            new GuiButton(
                0,
                guiLeft + (xSize / 2 - (80 / 2)),
                guiTop + 18,
                80,
                20,
                entity.whitelisted ? "Whitelist" : "Blacklist"));
        this.buttonList.add(
            new GuiButton(
                1,
                guiLeft + (xSize / 2 - (80 / 2)),
                ...
                80,
                20,
                entity.exact ? "Exact = No" : "Exact = Yes"));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        if (button instanceof GuiButton) {
            SonarCore.network
                .sendToServer(new PacketByteBufServer(entity, entity.xCoord, entity.yCoord, entity.zCoord, button.id));
            this.reset();
        }
