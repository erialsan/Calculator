...
public class GuiFluxController extends GuiFlux {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (!network()) {
            ...
            FontHelper.text(
                "T: " + ((entity.transmitterMode == 1) ? FontHelper.translate("network.on")
                    : (entity.transmitterMode == 2) ? FontHelper.translate("Hotbar")
                        : FontHelper.translate("network.off")),
                10,
                47,
                0);
    ...
    public class ModeButton extends SonarButtons.SonarButton {
        ...
        public void onClicked() {
            SonarCore.network
                .sendToServer(new PacketByteBufServer(entity, entity.xCoord, entity.yCoord, entity.zCoord, id));
            buttonList.clear();
            initGui();
        }
    }
