        ...
        if (!(this.entity.lightningSpeed < 600) && this.entity.lightingTicks < 500) {
            switch (this.entity.random) {
                ...
                case 1:
                    ...
                    this.fontRendererObj.drawString(
                        power1,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power1) / 2,
                        46,
                        4210752);
                    break;
                case 2:
                    ...
                    this.fontRendererObj.drawString(
                        power2,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power2) / 2,
                        46,
                        4210752);
                    break;
                case 3:
                    ...
                    this.fontRendererObj.drawString(
                        power3,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power3) / 2,
                        46,
                        4210752);
                    break;
                case 4:
                    ...
                    this.fontRendererObj.drawString(
                        power4,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power4) / 2,
                        46,
                        4210752);
                    break;
                case 5:
                    ...
                    this.fontRendererObj.drawString(
                        power5,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power5) / 2,
                        46,
                        4210752);
                    break;
                case 6:
                    ...
                    this.fontRendererObj.drawString(
                        power6,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power6) / 2,
                        46,
                        4210752);
                    break;
                case 7:
                    ...
                    this.fontRendererObj.drawString(
                        power7,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power7) / 2,
                        46,
                        4210752);
                    break;
                case 8:
                    ...
                    this.fontRendererObj.drawString(
                        power8,
                        this.xSize / 2 - this.fontRendererObj.getStringWidth(power8) / 2,
                        46,
                        4210752);
                    break;
            }
            ...
            String power = wait + (this.entity.lightningSpeed / 20 - this.entity.lightingTicks / 20)
                + " "
                + FontHelper.translate("lightning.seconds");
            this.fontRendererObj
                .drawString(power, this.xSize / 2 - this.fontRendererObj.getStringWidth(power) / 2, 46, 4210752);
        }
