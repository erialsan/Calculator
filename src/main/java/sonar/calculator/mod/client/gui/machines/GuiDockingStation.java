...
public class GuiDockingStation extends GuiContainer {
    ...
    public static final ResourceLocation calculatorTex = new ResourceLocation(
        "Calculator:textures/gui/dockingstation/calculator.png");
    public static final ResourceLocation scientificTex = new ResourceLocation(
        "Calculator:textures/gui/dockingstation/scientific.png");
    public static final ResourceLocation atomicTex = new ResourceLocation(
        "Calculator:textures/gui/dockingstation/atomic.png");
    public static final ResourceLocation flawlessTex = new ResourceLocation(
        "Calculator:textures/gui/dockingstation/flawless.png");
