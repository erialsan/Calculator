...
public class GuiAdvancedGreenhouse extends GuiContainer {
    ...
    public static final ResourceLocation bground = new ResourceLocation(
        "Calculator:textures/gui/advancedgreenhouse.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        if (entity.slots[1] == null) {
            itemRender.renderItemIntoGUI(
                ...
                new ItemStack(Blocks.oak_stairs, 64),
                this.guiLeft + 12 - 4,
                this.guiTop + 33 + 3);
        }
        ...
        if (entity.slots[3] == null) {
            itemRender.renderItemIntoGUI(
                this.fontRendererObj,
                this.mc.getTextureManager(),
                new ItemStack(Blocks.oak_stairs, 52),
                this.guiLeft + 48 - 4,
                this.guiTop + 33 + 3);
        }
        ...
        if (entity.slots[6] == null) {
            itemRender.renderItemIntoGUI(
                this.fontRendererObj,
                this.mc.getTextureManager(),
                new ItemStack(Blocks.planks, 40),
                this.guiLeft + 48 - 4,
                this.guiTop + 51 + 3);
        }
    }
