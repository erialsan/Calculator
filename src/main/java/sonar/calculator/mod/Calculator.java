...
@Mod(
    modid = Calculator.modid,
    name = "Calculator",
    version = Calculator.version,
    dependencies = "required-after:SonarCore")
public class Calculator {

    @SidedProxy(
        clientSide = "sonar.calculator.mod.network.CalculatorClient",
        serverSide = "sonar.calculator.mod.network.CalculatorCommon")
    ...
    public void postLoad(FMLPostInitializationEvent evt) {
        ...
        logger.info(
            RecipeRegistry.ConductorMastItemRecipes.instance()
                .getRecipes()
                .size() + " Conductor Mast Recipes Recipes were loaded");
        logger.info(
            AlgorithmSeparatorRecipes.instance()
                .getRecipes()
                .size() + " Algorithm Seperator Recipes were loaded");
        logger.info(
            ExtractionChamberRecipes.instance()
                .getRecipes()
                .size() + " Extraction Chamber Recipes were loaded");
        logger.info(
            GlowstoneExtractorRecipes.instance()
                .getRecipes()
                .size() + " Glowstone Extractor Recipes were loaded");
        logger.info(
            HealthProcessorRecipes.instance()
                .getRecipes()
                .size() + " Health Processor Recipes were loaded");
        logger.info(
            PrecisionChamberRecipes.instance()
                .getRecipes()
                .size() + " Precision Chamber Recipes were loaded");
        logger.info(
            ProcessingChamberRecipes.instance()
                .getRecipes()
                .size() + " Processing Chamber Recipes were loaded");
        logger.info(
            ReassemblyChamberRecipes.instance()
                .getRecipes()
                .size() + " Reassembly Chamber Recipes were loaded");
        logger.info(
            RedstoneExtractorRecipes.instance()
                .getRecipes()
                .size() + " Redstone Extractor Recipes were loaded");
        logger.info(
            StarchExtractorRecipes.instance()
                .getRecipes()
                .size() + " Starch Extractor Recipes were loaded");
        logger.info(
            StoneSeparatorRecipes.instance()
                .getRecipes()
                .size() + " Stone Separator Recipes were loaded");
    ...
    // common blocks
    public static Block reinforcedstoneBlock, reinforcedstoneBrick, reinforceddirtBlock, reinforceddirtBrick,
        purifiedobsidianBlock, stablestoneBlock, stablestonerimmedBlock, stablestonerimmedblackBlock, stableglassBlock,
        clearstableglassBlock, flawlessGlass;
    public static Block reinforcedStoneStairs, reinforcedStoneBrickStairs, reinforcedDirtStairs,
        reinforcedDirtBrickStairs;
