...
public class CalculatorConfig extends Calculator {
    ...
    /*
     * public static int calculatorEnergy; public static int craftingEnergy; public static int scientificEnergy; public
     * static int terrainEnergy; public static int advancedEnergy; public static int moduleEnergy; public static int
     * cubeEnergy; public static int starchRF; public static int redstoneRF; public static int glowstoneRF; public
     * static int conductorRF; public static int weatherstationRF; public static int growthRF; public static int
     * buildRF; public static int farmlandRF; public static int waterRF; public static int plantRF;
     */
    ...
    public static void loadMainConfig() {
        ...
        for (IntegerConfig usageConfig : integerConfigs) {
            int usage = config.getInt(
                usageConfig.name,
                usageConfig.usageType,
                usageConfig.defaultValue,
                usageConfig.min,
                usageConfig.max,
                usageConfig.name);
