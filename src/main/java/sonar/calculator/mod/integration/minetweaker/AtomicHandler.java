...
public class AtomicHandler {
    ...
    private static class AddRecipeAction implements IUndoableAction {
        ...
        @Override
        public void apply() {
            if (input1 == null || input2 == null || input3 == null || output == null) return;
            RecipeRegistry.AtomicRecipes.instance()
                .addRecipe(input1, input2, input3, output);
        }
        ...
        public void undo() {
            ...
            RecipeRegistry.AtomicRecipes.instance()
                .removeRecipe(input1, input2, input3);
        }
    ...
    private static class RemoveRecipeAction implements IUndoableAction {
        ...
        public RemoveRecipeAction(Object input1, Object input2, Object input3) {
            ...
            output = RecipeRegistry.AtomicRecipes.instance()
                .getCraftingResult(dummyInput1, dummyInput2, dummyInput3);
        }
