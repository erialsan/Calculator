...
public class FlawlessRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public SmeltingPair(Object input, Object input2, Object input3, Object input4, Object output) {
            ...
            if (input4 instanceof RecipeHelper.OreStack) input4 = ((RecipeHelper.OreStack) input4).getStacks();
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                FlawlessRecipeHandler.this.cycleticks / 48,
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(127, 28, 10, 8), "flawless", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("flawless")) && (getClass() == FlawlessRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = RecipeRegistry.FlawlessRecipes.instance()
                .getRecipes();
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        Map<Object[], Object[]> recipes = RecipeRegistry.FlawlessRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            if (RecipeRegistry.FlawlessRecipes.instance()
