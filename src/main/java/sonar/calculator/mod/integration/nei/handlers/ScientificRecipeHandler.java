...
public class ScientificRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(100, 25, 22, 14), "scientific", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("scientific")) && (getClass() == ScientificRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = RecipeRegistry.ScientificRecipes.instance()
                .getRecipes();
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        Map<Object[], Object[]> recipes = RecipeRegistry.ScientificRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            if (RecipeRegistry.ScientificRecipes.instance()
