...
public class ConductorRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                ConductorRecipeHandler.this.cycleticks / 48,
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(66, 19, 24, 10), "conductor", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("conductor")) && (getClass() == ConductorRecipeHandler.class)) {
            Map<ItemStack, ItemStack> recipes = RecipeRegistry.ConductorMastItemRecipes.instance()
                .getRecipeStacks();
