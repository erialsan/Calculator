...
public class RecipeInfoHandler extends CalculatorRecipeHandler {
    ...
    public void loadTransferRects() {
        ...
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(50, 2, 72, 12), "calculator", new Object[0]));
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(50, 20, 72, 12), "New-Recipes", new Object[0]));
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(
                new Rectangle(50, 38, 72, 12),
                "Standard-Recipes",
                new Object[0]));
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(
                new Rectangle(50, 56, 72, 12),
                "Unlocked-Recipes",
                new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
         ...
         * Minecraft.getMinecraft().thePlayer.getHeldItem().getItem() == Calculator.itemCalculator) {
