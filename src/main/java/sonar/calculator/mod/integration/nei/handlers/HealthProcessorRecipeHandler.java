...
public class HealthProcessorRecipeHandler extends TemplateRecipeHandler {
    ...
    public class ChancePair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                HealthProcessorRecipeHandler.this.cycleticks / 48,
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("healthvalue")) && (getClass() == HealthProcessorRecipeHandler.class)) {
            Map<ItemStack, Integer> recipes = HealthProcessorRecipes.instance()
                .getRecipes();
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        int healthValue = (Integer) HealthProcessorRecipes.instance()
            .getOutput(ingredient);
        if (healthValue != 0) {
