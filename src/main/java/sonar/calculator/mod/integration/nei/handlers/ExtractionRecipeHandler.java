...
public class ExtractionRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public List<PositionedStack> getOtherStacks() {
            return getCycledIngredients(
                ExtractionRecipeHandler.this.cycleticks / 48,
                Arrays.asList(new PositionedStack[] { this.result2 }));
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(52, 19, 24, 10), "extraction", new Object[0]));
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(
                new Rectangle(49 - 5, 63 - 11, 78, 10),
                "calculatordischarge",
                new Object[0]));
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("extraction")) && (getClass() == ExtractionRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = ExtractionChamberRecipes.instance()
                .getRecipes();
            for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
                this.arecipes.add(
                    new SmeltingPair(
                        recipe.getKey()[0],
                        recipe.getValue()[0],
                        ((ItemStack) recipe.getValue()[1]).getItem() == Calculator.circuitDamaged
                            ? CalculatorOreDict.circuitList(1)
                            : CalculatorOreDict.circuitList(2)));
            }
        } else {
    ...
    public void loadCraftingRecipes(ItemStack result) {
        ...
        Map<Object[], Object[]> recipes = ExtractionChamberRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            int pos = ExtractionChamberRecipes.instance()
