...
public class AtomicRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public SmeltingPair(Object input, Object input2, Object input3, Object output) {
            super();
            if (input instanceof RecipeHelper.OreStack) input = ((RecipeHelper.OreStack) input).getStacks();
            if (input2 instanceof RecipeHelper.OreStack) input2 = ((RecipeHelper.OreStack) input2).getStacks();
            if (input3 instanceof RecipeHelper.OreStack) input3 = ((RecipeHelper.OreStack) input3).getStacks();
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                AtomicRecipeHandler.this.cycleticks / 48,
                Arrays.asList(new PositionedStack[] { this.input, this.input2, this.input3 }));
        }
    ...
    public void loadTransferRects() {
        this.transferRects
            .add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(100, 25, 22, 14), "atomic", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("atomic")) && (getClass() == AtomicRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = RecipeRegistry.AtomicRecipes.instance()
                .getRecipes();
    ...
    public void loadCraftingRecipes(ItemStack result) {
        ...
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            if (NEIServerUtils.areStacksSameType((ItemStack) recipe.getValue()[0], result)) {
                this.arecipes.add(
                    new SmeltingPair(recipe.getKey()[0], recipe.getKey()[1], recipe.getKey()[2], recipe.getValue()[0]));
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        Map<Object[], Object[]> recipes = RecipeRegistry.AtomicRecipes.instance()
            .getRecipes();
        for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
            if (RecipeRegistry.AtomicRecipes.instance()
                .containsStack(ingredient, recipe.getKey(), false) != -1)
                this.arecipes.add(
                    new SmeltingPair(recipe.getKey()[0], recipe.getKey()[1], recipe.getKey()[2], recipe.getValue()[0]));
