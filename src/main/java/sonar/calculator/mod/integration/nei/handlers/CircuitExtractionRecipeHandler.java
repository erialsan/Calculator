...
public class CircuitExtractionRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(
                new Rectangle(26 - 11, 20 - 5, 116, 8),
                "circuitextraction",
                new Object[0]));
    ...
    public void loadCraftingRecipes(ItemStack result) {
        ...
        if (AnalysingChamberRecipes.instance()
            .getChance(result) != 0) {
            this.arecipes.add(
                new ChancePair(
                    result,
                    AnalysingChamberRecipes.instance()
                        .getChance(result)));
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("circuitextraction")) && (getClass() == CircuitExtractionRecipeHandler.class)) {
            Map<ItemStack, Integer> recipes = AnalysingChamberRecipes.instance()
                .getChanceList();
