...
public class CalculatorRecipeHandler extends TemplateRecipeHandler {
    ...
    public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(
                CalculatorRecipeHandler.this.cycleticks / 16,
    ...
    public void loadTransferRects() {
        this.transferRects.add(
            new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(100, 25, 22, 14), "calculator", new Object[0]));
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if ((outputId.equals("calculator")) && (getClass() == CalculatorRecipeHandler.class)) {
            Map<Object[], Object[]> recipes = RecipeRegistry.CalculatorRecipes.instance()
                .getRecipes();
