...
public class TreeHarvestRecipes extends RecipeHelper {
    ...
    public void addRecipes() {
        this.addRecipe(
            Calculator.pearLeaf,
            new ItemStack(Calculator.pear, 1),
            new ItemStack(Calculator.rotten_pear, 1));
        this.addRecipe(
            Calculator.diamondLeaf,
            new ItemStack(Calculator.weakeneddiamond, 1),
            new ItemStack(Calculator.flawlessdiamond, 1));
    }
